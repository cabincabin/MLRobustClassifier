...
if __name__== "__main__":
    ...
    # Creates a batch in ImageLabelDict in the format [ImageArr, ID]
    testDict, idsToRemoveFromEachBatchTest, SuccessNumTest = CreateBatchOfImages(250, idsToRemoveFromEachBatchTest, "gs://mlclassifiertuning/Imagefiles256x256/")
    #ImageLabel = {1: [[0],'9eb39d618fd92994'], 2: [[0],'025a6cccec41134'], 3: [[0],'002200be72145198'], 4:[[0],'003d4acb635f05b7']}
    ...
    model.main(ImageLabelDict, getIDLabelDict(pointsTest), SuccessNum, "gs://mlclassifiertuning/imageIds/sharpenminiResultsLabel/", testDict)
